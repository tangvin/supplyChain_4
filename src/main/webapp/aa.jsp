...
<div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
    <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
        <div id="topbar" class="top-bar">
            <div class="top-bar-left">
                <h1 style="margin-left: 10px; margin-top: 10px;color: #fff">运营<span style="color: #3F4752">后台管理系统</span></h1>
            </div>
        ...
        <div id="toolbar" class="panel-header panel-header-noborder top-toolbar">
            <div id="infobar">
                    <span class="icon-hamburg-user" style="padding-left: 25px; background-position: left center;">
                       <sec:authentication property="name"/>，您好
                    </span>
            </div>
                ...
                <div title="{{p_permission.name }}" style="padding: 5px;"
                    ...
                    <div>
                        ...
                        <a id="btn" class="easyui-linkbutton" data-options="plain:true,iconCls:'{{c_permission.icon }}'"
                           ...
                           onclick="window.mainpage.mainTabs.addModule('{{c_permission.name}}','${ctx}'+'{{c_permission.url }}','{{c_permission.icon }}')">{{c_permission.name}}</a>
                        {{/if}}
                        {{/each}}
                    </div>
                </div>
    ...
    <div data-options="region: 'south', title: '关于...', iconCls: 'icon-standard-information', collapsed: true, border: false" style="height: 70px;">
        <div style="color: #4e5766; padding: 6px 0 0 0; margin: 0 auto; text-align: center; font-size:12px; font-family:微软雅黑;">
