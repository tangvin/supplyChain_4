...
<div class="home_wrap">
    ...
    <div class="home_main">
        ...
        <!--home 产品功能 开始-->
        <!--home 供应链金融系统 开始-->
        <div class="home_cpjs home_gyljrxt">
            <div class="home_width">
                <p class="home_main_title home_gyljrxt_title clearfix">
                    <span class="home_xian"></span>
                    <span class="home_cpzx home_gyljrxt_span">供应链金融系统</span>
                    <span class="home_xian"></span>
                </p>
