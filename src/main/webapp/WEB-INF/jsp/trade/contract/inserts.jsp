...
<div class='col-xs-12'>
    <div class='row'>
        ...
        <div class="col-xs-12 zlxx_top">
            ...
            <span>></span>
            <a href="<%=request.getContextPath()%>/tradeMain/htqy.action">合同签约</a>
            <span>></span>
            <a href="#">新增合同1</a>
        </div>
        <!--合同签约 头部 end-->
        <div class="col-xs-12">
            ...
            <!--合同编辑表格 end-->
            <div class="row">
                <button type="button" class="btn  btn-danger col-xs-offset-4" data-toggle="modal" data-target=".bs-example-modal-tj">保存</button>
