...
public class AddressUtils {
	...
	public String getAddress(String params, String encoding) throws Exception{
		...
		if(returnStr != null){
			...
			/*json = new JSONObject();
			json.parse(returnStr);*/
			if("0".equals(json.get("code").toString())){
			   
				
				StringBuffer buffer = new StringBuffer();
				String date = json.get("data").toString();
				JSONObject parseObject = JSON.parseObject(date);
				/*System.out.println((String)parseObject.get("country"));
				System.out.println((String)parseObject.get("area"));
				System.out.println((String)parseObject.get("region"));
				System.out.println((String)parseObject.get("city"));
				System.out.println((String)parseObject.get("county"));
				System.out.println((String)parseObject.get("isp"));*/
			...
			/*	
				...
				*/
				//System.out.println(parseObject.get("region").toString().equals(""));
				return parseObject.get("region").toString();
