...
public class Order {
   ...
   // 收货人
	...
	public int hashCode() {
		...
		result = prime * result + ((fphone == null) ? 0 : fphone.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (fName == null) {
			...
			return false;
		if (fperson == null) {
			if (other.fperson != null)
				return false;
		} else if (!fperson.equals(other.fperson))
			return false;
		if (fphone == null) {
			if (other.fphone != null)
				return false;
		} else if (!fphone.equals(other.fphone))
			return false;
		if (freightName == null) {
	...
	public String toString() {
		return "Order [orderId=" + orderId + ", orderNumber=" + orderNumber + ", orderCreatTime=" + orderCreatTime
				...
				+ procurementEntName + ", tradeEntName=" + tradeEntName + ", contractName=" + contractName
				+ ", contractNumber=" + contractNumber + ", freightName=" + freightName + ", amount=" + amount
