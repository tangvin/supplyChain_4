...
import cn.com.edzleft.dao.trade.letter.TradeLefferMapper;
...
@Service
@Transactional
public class TradeLetterServiceImpl implements TradeLetterService {

   @Autowired
   private TradeLefferMapper letterMapper;
